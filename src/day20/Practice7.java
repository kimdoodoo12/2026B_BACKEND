...
System.out.print(book1.title + book1.author + book1.price);
System.out.println(); 
System.out.print(book2.title + book2.author + book2.price); 
...
System.out.print("입금하실 금액: "); int deposit = scanner.nextInt();
bankAccount.balance += deposit;
System.out.print("출금하실 금액: "); int withdraw = scanner.nextInt();
bankAccount.balance -= withdraw;
System.out.println("출금후 잔액: " + bankAccount.balance);
...
if (product1.price > product2.price){ System.out.println(product1.name);}
else {System.out.println(product2.name);}
...
System.out.println("로그인전 상태: " + member1.isLogin);
member1.isLogin = true;
System.out.println("로그인후 상태: " + member1.isLogin);
...
MenuItem menuItem2 = new MenuItem(); menuItem2.name = "된장찌개"; menuItem2.price = 8000; menuItem2.isSignature = false;
MenuItem menuItem3 = new MenuItem(); menuItem3.name = "계란찜"; menuItem3.price = 3000; menuItem3.isSignature = false;
...
System.out.print("이름: "); userProfile.name = scanner.next();
System.out.print("나이: "); userProfile.age = scanner.nextInt();
System.out.print("MBTI: "); userProfile.mbti = scanner.next();
System.out.println();
System.out.println("--- 프로필 ---");
System.out.print("이름: " + userProfile.name); System.out.println(", 나이: " + userProfile.age + ", MBTI: " + userProfile.mbti);
    }
}
