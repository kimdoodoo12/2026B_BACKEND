...
BankAccount b1Account = new BankAccount("123-456");
System.out.println(b1Account.getAccountNumber());
...
class Score{
    ...
    void setScore(int score){
        ...
        else {System.err.println("유효하지 않은 점수입니다.");}
    }
...
class TicketMachine{
    ...
    void issueTicket(){
        totalTickets++;
        System.out.println("티켓을 1장 발권했습니다");
    }
