...
nameList.add("강호동"); nameList.add("유재석"); nameList.add("신동엽");
...
ArrayList<String> charList = new ArrayList<>(List.of("A", "B", "C", "D", "E"));
charList.remove(2);
...
ArrayList <String> langList = new ArrayList<>(List.of("자바", "파이썬", "C++"));
langList.add(1, "자바스크립트");
...
ArrayList<String> arrayList = new ArrayList<>(List.of("국어", "수학", "사회", "과학"));
arrayList.set(1, "영어");
